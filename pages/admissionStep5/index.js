    ...
    <div className="container">
      ...
      >
        ...
        >
          ...
          report immediately to the appropriate authority. Thereafter click on
          the Fill Student Form button to fill your form.
        </p>
        ...
        <div className="d-block d-lg-flex d-xl-flex">
          ...
          <div style={{ margin: "6em 0", height: "43px", marginLeft: ".1rem" }}>
            <a
              href="#"
              style={{
                // display: "flex",
