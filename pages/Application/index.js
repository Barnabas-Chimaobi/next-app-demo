        ...
        <div className="container d-block d-lg-flex">
          ...
          <div className="card col-lg-8 col-sm-12">
            <div className="p-3 mt-4">
              <h4>RRR Number</h4>
              <p>
                Kindly Enter your RRR number (specified on your invoice), and
                click the Next Button to fill your Application Form. <br />
                Ensure you print your Acknowledgement Slip and Exam Slip after
                the submission of your form.
              </p>
            </div>
            <div>
