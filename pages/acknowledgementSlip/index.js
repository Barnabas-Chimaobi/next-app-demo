                ...
                <div className="row">
                        ...
                        <div className="col-6">
                            <div className="row">
                                <div className="col-12">
                                <p>Email</p>
                                <p><strong>ifeoluwadeborah@gmail.com</strong></p>
                                </div>
                                <div className="col-12">
                                <p>LGA</p>
                                <p><strong>ADO-EKITI</strong></p>
                                </div>
                                <div className="col-12">
                                <p>Department</p>
                        ...
                        <div className="row">
                            <div className="col-6">
                                ...
                                <div className="col-12">
                                    <p>Next Of Kin</p>
                                    <p><strong>IFEOLUWA HELEN</strong></p>
                                </div>
                                <div className="col-12">
                                    <p>Contact Address</p>
                                    <p><strong>1A ILUPEJU STREET, YABA, LAGOS</strong></p>
                                </div>
                                </div>
                            </div>
                            <div className="col-6">
                        ...
                        <div className="row">
                            <div className="col-6">
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                    <p>Type</p>
                                    <p><strong>WAEC (MAY/JUNE)</strong></p>
                                    </div>
                                    <div className="col-12">
                                    <p>Exam Year</p>
                            ...
                            <div className="col-6">
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                    <p>Type</p>
                                    <p><strong>NECO JUNE/JULY</strong></p>
                                    </div>
                                    <div className="col-12">
                                    <p>Exam Year</p>
                                    <p><strong>2020</strong></p>
                       ...
                       <div className="col-12 mt-3">
                            <div className="row">
                                <div className="col-6">
                                    ...
                                    <div className="col-8">
                                        ...
                                        <p><strong>FURTHER MATHEMATICS</strong></p>
                                    </div>
                                    <div className="col-4">
                                        <p>Grades</p>
                                        <p><strong>A</strong></p>
                        ...
                        <div className="mt-4 mb-2">
                            <button type="submit" className="btn bg-success"><a className="submit-link" href style={{textDecoration: 'none'}}>Print Slip</a></button>
                            <button type="submit" className="btn bg-white text-success border border-success ml-5" style={{}}><a className="submit-link text-success" href="thankYou.html" style={{textDecoration: 'none'}}>Finish</a></button>
                        </div>
                </div>
            </div>
            <ProgressCard />
