...
export default function Home() {
  const [appStart, { loading: appLoading, error: appError, data: appData }] =
    useMutation(GENERATE_APPLICATION_INVOICE);
          ...
          <div className="d-block d-lg-flex">
              ...
              <form>
                ...
                >
                  {/* <a
                    ...
                    // href="/makePayment"
                  > */}
                  <label className="submit-link">Submit</label>
                  {/* </a> */}
                </button>
              </form>
            </div>
            ...
            >
              ...
              <div className="lightGreen rounded  text-white p-4">
                <p>
                  Ensure to check the course requirements on the department's
                  page of the official site{" "}
                </p>
              </div>
            </div>
          </div>
