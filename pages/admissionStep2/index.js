    ...
    <div>
        <div className='container d-lg-flex'>
            <div  className='col-lg-8 col-sm-12'>
                ...
                <div className='d-block container mt-3 mb-3 card pl-5 pt-5 pb-5 pr-5'>
                    <div className="row">
                        <p style={{fontSize: '20px'}} className='pb-3'><strong>Verify / Modify O’Level Result</strong></p>
                    ...
                    <div className="col-lg-12">
                        <div className="row">
                            ...
                            <div className='mt-5 text-right' style={{gap: '10'}}>
                                <button className='btn text-success border-success' style={{width: '120px'}}>Submit</button>
                                <button className='btn text-white btn-success' style={{width: '120px'}}>Next</button>
                            </div>
                        </div>
                    </div>
                    </div>
